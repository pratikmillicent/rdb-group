                ...
                {data?.map((item, index) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="d-flex justify-content-left align-items-end gap-3  pt-2">
                        <div>
                          <h5 className="director-title mb-0">R.D.Brothers</h5>
                          <div className="d-flex align-items-center gap-3 mb-4 ">
                            <h1 className="director-head  m-0">{item.type}</h1>
                            <FaBuilding fontSize={24} color="var(--golden)" />
                          </div>
                        </div>
                      </div>
