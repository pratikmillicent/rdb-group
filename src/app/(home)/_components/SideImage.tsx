...
//         </div>
//       </div>
//       <div className="bg-img bg-left parallaxie d-flex align-items-center justify-content-center" data-background="/assets/images2/img1.jpg">
//         <div className="vid-circle bg-white text-dark">
//           <a href="https://youtu.be/5OoYcqw6nXs?si=sXvnZ8tqSqAwAVxy" className="vid" onClick={openVideo}>
//             <span className="icon">
...
function SideImage() {
  const [isVideoOpen, setIsVideoOpen] = useState(false);
  const [videoDetails, setVideoDetails] = useState({ videoId: '', channel: '' });
  ...
  function openVideo(event:any) {
    event.preventDefault();
    setVideoDetails({ videoId: '5OoYcqw6nXs', channel: 'youtube' }); // Set the video details here
    setIsVideoOpen(true);
  }
