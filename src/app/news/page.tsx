  ...
  return (
    <>
      ...
      <div className="row grid md-marg">
        {
          data.map((item) => (
            <div className={`col-lg-4 col-md-6 items  info-overlay mb-50`} key={item.id}>
      ...
      <div className="row grid md-marg">
        {
          data1.map((item) => (
            <div className={`col-lg-3 col-md-6 items  info-overlay mb-50`} key={item.id}>
              <div className="item-img o-hidden">
      ...
      <div className="row grid">
            {
              data3.map((item) => (
                <div className={`col-md-6 items info-overlay mb-80 d-flex justify-content-center`} key={item.id}>
                  <div className="item-img o-hidden">
