            ...
            <div className="container">
                <div className="d-flex gap-3">
                    ...
                    <div className="col-12 col-md-11">
                        <p className="fs-4 fw-bold text-dark">Questions or concerns? Contact Us Now!</p>
                            ...
                            <div className="row">
                                <div className="col-12">
                                    <textarea
                                        ...
                                        className="w-100 mb-2 p-2 inpt_box rounded border-secondary bg-dark text-light"></textarea>
                                    <button className="btn btn-danger rounded border-secondary cnt_btn1">Send</button>
                                </div>
                            </div>
                        </div>
                        <div className='d-flex gap-3'>
                            <div className="col-12 col-md-1 bg-danger contact_line mt-3"></div>
                            <div className='col-12 col-md-11'>
                                <p className="fs-4 fw-bold text-dark">React out for assistance and suuport.We're hre to listen and help you thrive</p>
                                <p className='fs-4 fw-bold text-dark text-center'>Registered Offices:</p>
                                <div className="row text-light msg_box">
                                    <div className="col-12 col-md-4 mb-2">
                                        <p className='text-dark fw-bold'>Aspect Global Ventures Pvt.Ltd.:</p>
                                    ...
                                    <div className="col-12 col-md-4  mb-2">
                                        <p className='text-dark fw-bold'>Aspect Bullion & Refinery:</p>
